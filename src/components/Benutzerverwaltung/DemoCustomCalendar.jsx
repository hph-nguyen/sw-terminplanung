...
import "./calendar.css";
import { ArrowBack, ArrowForward, ChevronLeft } from "@mui/icons-material";
import CustomWeekView from "../Terminplanung/CustomWeekView";
...
export default function DemoCustomCalendar() {
